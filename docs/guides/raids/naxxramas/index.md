# 💀 Naxxramas (Naxx) Raid Guide

The pinnacle of Classic raiding. This 40-man necropolis is divided into four distinct wings and a central frost-wyrm lair. Success here requires near-perfect execution, massive consumable stocks, and **Frost Resistance (FrR)** for the final encounters.
...
### 💎 Notable Loot
* **Tier 3 (Faith, Dreadnaught, etc.):** The most powerful armor sets in Classic.
* **The Phylactery:** Drops from Kel'Thuzad; used to obtain the best-in-slot Sapphiron/KT trinkets.
* **Atiesh, Greatstaff of the Guardian:** The legendary staff (requires 40 splinters from Naxx bosses).